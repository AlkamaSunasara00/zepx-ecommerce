...
import '../../../../assets/css/admin/product/watch.css';
        ...
        <div className='main-product-container'>
            <div className='header-product'>
                <div className='header-product-txt'>
                    <p>Products<span><i class="fa-solid fa-caret-right"></i> <b>Watches</b></span></p>
                </div>
                    ...
                    <tbody>
                        <tr>
                            <td className='product-info'>
                                <div id='product-img'>
                                <img src={require('../../../../assets/images/admin/image.png')} alt="iPhone 11 Pro" />
                                </div>
                            </td>
                            <td>
                            <p>iPhone 11 Pro</p>
